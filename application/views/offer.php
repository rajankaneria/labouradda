...
<div class="container">
    ...
    <div class="row" style="position: relative;    margin-bottom: 200px;">
        <div class="offering-container col s12 m2 card-panel">
            ...
            <div class="offering-description">The work that you can get done through labours are - Labours for cleaning by shifting furniture’s, Labours for Cleaning fixtures and fans, Labour for cleaning doors & windows, Labour for cleaning cabinets and shelves, Labour for Loft cleaning, Labour for overhead tank cleaning, labour for Garden cleaning .</div>
        </div>
        <div class="offering-container col s12 m2 card-panel">
            ...
            <div class="offering-description">You get substitute for maids, replacement of maids, substitute for drivers, substitute for parents care in old age, helpers for home or small party & get together, substitute for day guard, night guard, substitute for gardeners, substitute for washing and mopping entire floors and roof tops & car cleaners. </div>
        </div>
        <div class="offering-container col s12 m2 card-panel">
            ...
            <div class="offering-description">You get labours as solution for quick fixes from plumbers, carpenters, painters, electricians, mason (mistri), fabricator, car repair and maintenance, car tyre repair & maintenance. AC Repair & Maintenance, Cooler repair and maintenance.  </div>
        </div>
        <div class="offering-container col s12 m2 card-panel">
            ...
            <div class="offering-description">(1st) You get choice of Three wheelers & Four wheelers with or without labours (2nd) You get labours for packing & unpacking, loading and unloading, taking up the staircase if heavy and large furniture for lift not available or not allowed. Since all the Loaders and un-loaders booked are adhaar card holders you can build a trust on them by cross checking identity of the labour through our call center by giving your booking ID and labours unique ID.</div>
        </div>
        <div class="offering-container col s12 m2 card-panel">
            ...
            <div class="offering-description">You can place a request for more than one labour for your requirement for more than one day. Labouradda will send you a list of labours with their unique ID a day in advance.  Since all the Loaders and un-loaders booked are adhaar card holders you can build a trust on them by cross checking identity of the labour through our call center by giving your booking ID and the unique ID of the labour.
        </div>
        </div>
        <div class="offering-container col s12 m2 card-panel">
